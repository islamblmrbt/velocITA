...
const OnBoarding = () => {
    ...
    return (
        <SafeAreaView className="flex h-full items-center justify-between bg-white">
            ...
            dot={
            <View
            className="w-[3px] h-[4px] mx-1 bg-[#E2E8F0] rounded-full"
            />
            }
            activeDot={
            <View
            className="w-[3px] h-[4px] mx-1 bg-[#0286FF] rounded-full"
            />
            }
            ...
            >
                ...
                >
                    ...
                    <Text
                        className="text-lg font-JakartaSemiBold text-center text-[#858585] mx-10 mt-3"
                        >
                            {item.description}
                    </Text>
                </View>
